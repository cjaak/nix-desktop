{
  ...
  inputs = {
    ...
    jovian-nixos.url = "github:Jovian-Experiments/Jovian-NixOS/6087aab8ab19bc314bbe132c6f3114a85d772375";
  };

  outputs = { self, nixpkgs, nixpkgs-unstable, deploy-rs, jovian-nixos, ... }@attrs:
  let
    system = "x86_64-linux";
